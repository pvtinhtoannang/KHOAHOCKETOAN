<div class="modal fade featured-image-modal" id="featured-image-modal" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" id="media-button-select" class="btn btn-primary media-button-select" disabled="disabled">Đặt làm ảnh đại diện</button>
            </div>
        </div>
    </div>
</div>
