...
class Post extends Model
{
    ...
    {
        $all = $this->type($post_type)->not_status('trash')->latest()->get();
        $trash = $this->type($post_type)->status('trash')->latest()->get();
        $pending = $this->type($post_type)->status('pending')->latest()->get();
        $draft = $this->type($post_type)->status('draft')->latest()->get();
        $publish = $this->type($post_type)->status('publish')->latest()->get();
        return array(
            'all' => count($all),
